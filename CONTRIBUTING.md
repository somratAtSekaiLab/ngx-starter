...
* Run the project with `ng build --configuration=production --prod --aot=true` to make sure build is ok with production mode
...
* In GitLab, send a pull request to `ngx-starter:develop`.
...
* code commending guideline https://compodoc.app/guides/comments.html
